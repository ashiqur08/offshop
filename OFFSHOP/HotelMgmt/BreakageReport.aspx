<%@ Page Language="C#" MasterPageFile="~/Common.Master" AutoEventWireup="true" CodeBehind="BreakageReport.aspx.cs" Inherits="HotelMgmt.BreakageReport" Title="Untitled Page" %>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnShow" runat="server" onclick="btnShow_Click" 
                    Text="Show" Width="86px" CssClass="btn" />
            </td>
        </tr>
        <tr>
