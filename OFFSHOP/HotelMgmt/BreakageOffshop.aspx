<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BreakageOffshop.aspx.cs"
    Inherits="HotelMgmt.OffshopBreakage" %>
...
<body>
    ...
    <div class="nav">
        <ul class="menu" id="menu">
            ...
            <li><a href="Login/LoginUser.aspx" onclick="return confirm('Are you sure?')" class="menulink" onmouseout="MM_swapImgRestore()"
                onmouseover="MM_swapImage('Image7','','images/exit_btn_o.gif',1)">
    ...
    <div class="sale">
        <div class="area3">
            <div class="header">
                <h1>
                    Offshop Breakage Details&nbsp;&nbsp;&nbsp;Sujata Sen F.l. Offshop.</h1>
            </div>
            <table class="style17">
                <tr>
                    <td>
                                                                            ...
                                                                            <td valign="top" class="style4">
                                                                                <div style="overflow: auto; width: 100%; height: 180px">
                                                                                    <asp:GridView ID="gvDetails" runat="server" CssClass="grid" CellPadding="4" ForeColor="#333333"
                                                                                        GridLines="None" AutoGenerateColumns="False" DataKeyNames="OffshopBreakageId"
                                                                                        OnRowEditing="gvDetails_RowEditing" Width="980px">
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <asp:TemplateField>
                                                                                                <ItemTemplate>
                                                                                                    <asp:Label ID="lblBreakageId" runat="server" Text='<%# Bind("OffshopBreakageId") %>' Visible="False"></asp:Label>
                                                                                                </ItemTemplate>
                                                                                                <EditItemTemplate>
                                                                                                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("OffshopBreakageId") %>'></asp:TextBox>
                                                                                                </EditItemTemplate>
                                                                                            </asp:TemplateField>
                                                                                        </Columns>
